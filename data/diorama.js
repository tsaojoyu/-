  ...
  techniques: {
    ...
    items: [
      ...
      },
      {
        name: '流刺網',
        subtitle: '網牆入海，等魚自己來',
        description: '流刺網也是花蓮漁港相當普遍的漁法之一，作業方式是將裝有浮球與衛星信標的網具施放入海，在水中形成一道長達千餘公尺的網牆，等待隨潮流游過的魚群「刺」入網眼，並在掙扎過程中與網纏繞。\n\n漁民通常天黑前抵達漁場放網，靜待兩三小時後起網，一個夜晚作業兩輪。流刺網浮於海水表層，主要捕撈馬加、土魠、旗魚、煙仔虎等中上層魚種。',
        quote: null,
        quoteSource: null,
        images: []
      },
